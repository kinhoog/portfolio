...
export const profile = {
  name: "erick rocha",
  shortName: "erick",
  headline: "olá, sou o erick!",
  subtitle: "sistemas internos, automações e ia aplicada",
  description:
  ...
  about:
    "sou erick, estudo gestão de ti e tenho formação prática em\nprogramação, modelagem de software e redes.",
  aboutSecond:
